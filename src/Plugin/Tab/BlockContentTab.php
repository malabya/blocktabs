...
class BlockContentTab extends ConfigurableTabBase {
  ...
  public function getContent() {
	...
	if(!empty($block_uuid)){
    $block = \Drupal::entityTypeManager()->loadEntityByUuid('block_content', $block_uuid);
	
    $block_render_array = \Drupal::entityTypeManager()->getViewBuilder($block->getEntityTypeId())->view($block, 'default');
